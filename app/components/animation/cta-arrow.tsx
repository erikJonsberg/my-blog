...
export const CTAArrow = () => (
	<div className='absolute left-[285px] bottom-[1px]'>
		...
		<span className='block text-sm w-fit bg-indigo-500 text-white shadow px-2 py-1 rounded -mt-1 mr-8 rotate-2 font-light italic'>
			Click on a dot!
		</span>
	</div>
);

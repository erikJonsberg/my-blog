...
import HeadlineMobileView from './headline-mobile-view';
...
export default function Hero() {
	...
	return (
		<section className='text-gray-900 dark:text-gray-50 overflow-hidden px-8 lg:pt-24 pb-8 md:px-12 md:pt-12 md:pb-9'>
			<div className='relative mx-auto max-w-5xl'>
				{isMobile ? (
					...
					<div className='pointer-events-none relative z-10'>
						<Reveal>
							<h1 className='pointer-events-auto leading-5 text-6xl font-black text-gray-950 dark:text-gray-50 md:text-8xl'>
								Hi, I&apos;m{' '}
						...
						<Reveal>
							<p className='pointer-events-auto max-w-xl text-sm text-gray-950 dark:text-gray-100 md:text-base'>
								With 15 years under my belt in the web development industry,
								I've journeyed from the bloated ecosystem of WordPress,
								sculpting bespoke websites, to now embracing the cutting-edge
								trio of Next.js, Tailwind CSS, and Sanity headless CMS. My
								evolution in the field is not just about changing tools but
								about adapting and thriving amidst the digital renaissance.
								Let&apos;s connect! 👏{' '}
							</p>
						</Reveal>
						<Reveal>

...
export default function Category({ category }: { category: SanityDocument }) {
	return (
		<section className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-24'>
			<h1 className='text-center p-6 font-extrabold text-5xl bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent'>
				Category:{' '}
				<span className='dark:text-gray-50 text-gray-900'>
					{category.title}
				</span>
			</h1>
